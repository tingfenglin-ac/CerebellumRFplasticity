...
% 2. Change the current folder to "PFstimulation_map plasticity\probability"
% 3. analyze the data within the folder of "PFstimulation_map plasticity\probability"
