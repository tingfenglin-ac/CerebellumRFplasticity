...
% 2. Change the current folder to "Airpuff_map plasticity\probability"
% 3. analyze the data within the folder of "Airpuff_map plasticity\probability"
...
conloc=nanmean(cat(3,location1,location2),3);
con_data=conloc;
...
formatSpec = '%.3f';
FS=16;
Ysig=0.87;Yincre=0.07;sigincre=0.008;
...
%% Section 3: plot normalized probability (mean+sem) of all genotypes before and after tetanization
% ctrl+enter to run this section
...
for i=1:size(gcomb,1)
    ...
    Ysig=1.7;Yincre=0.08;sigincre=0.009;
